...
var handleDashboardGritterNotification = function() {
	setTimeout(function() {
		$.gritter.add({
			title: '自動登出提醒',
			text: '系統即將於 <span class="text-red">3 分 13 秒</span>後直接登出 <br/><a href="#" class="btn btn-xs btn-yellow fs-10px ps-2 pe-2">延長登出時間</a>',
			image: '../assets/img/user/user-AI.png',
			sticky: true,
			time: '',
